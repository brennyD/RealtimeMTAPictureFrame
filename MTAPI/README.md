# This is a fork of the original MTA JSON proxy, [found here](https://github.com/jonthornton/MTAPI/tree/master), that adds a new endpoint to fetch time info for the arduino, as well as updates some of the data types returns in API calls
